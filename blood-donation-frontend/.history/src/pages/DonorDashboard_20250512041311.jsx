  ...
  return (
    <div className="container" style={{ marginTop: "30px" }}>
      ...
      {editing ? (
        ...
        <div>
          {donor.username ? <p><strong>Username:</strong> {donor.username}</p> : null}
          {donor.age ? <p><strong>Age:</strong> {donor.age}</p> : null}
          {donor.blood_group ? <p><strong>Blood Group:</strong> {donor.blood_group}</p> : null}
