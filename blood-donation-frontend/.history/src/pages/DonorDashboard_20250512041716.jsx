  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (res.data?.donor) {
          setDonor({
            username: res.data.donor.username || "Not provided",
            age: res.data.donor.age || "Not provided",
            blood_group: res.data.donor.blood_group || "Not provided"
          });
        }
      } catch (err) {
        setDonor({
