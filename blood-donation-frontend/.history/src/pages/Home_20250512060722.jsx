...
import '../Home.css';
import React from 'react';
import video1 from '../Videos/video_1.mp4';   // Import video 1
import video2 from '../Videos/video_2.mp4';   // Import video 2
//import poster from '../Videos/poster2.jpg';   // Import poster image
          ...
          <Row className="justify-content-center">
            <Col md={6} className="mb-4 text-center">
              <div className="video-wrapper">
                <video controls width="100%"poster="/poster1.jpg">
            ...
            <Col md={6} className="mb-4 text-center">
              <div className="video-wrapper">
                <video controls width="100%" poster="/poster2.jpg">
